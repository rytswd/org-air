...
A modern, aesthetic GTD dashboard *and* Air project viewer for Emacs — built on
[[https://github.com/alphapapa/org-ql][org-ql]], with no ~org-agenda~.
...
quiet, legible visual language inspired by [[https://github.com/rougier/nano-emacs][N Λ N O]]
and mu4e.
...
For repositories planned with [[https://github.com/rytswd/air][Air]], the project
